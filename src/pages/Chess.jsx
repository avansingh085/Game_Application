          ...
          <div className="flex gap-2">
            {['classic', 'green', 'blue', 'pink'].map((theme) => (
              <button
                ...
                className={`w-8 h-8 rounded-full border-2 ${boardTheme === theme ? 'border-yellow-400 scale-110' : 'border-transparent'
                  } transition-all ${theme === 'classic' ? 'bg-amber-200' : ''} ${theme === 'green' ? 'bg-emerald-400' : ''
